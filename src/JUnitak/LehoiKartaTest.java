...
public class LehoiKartaTest {
	...
	public void setUp() throws Exception {
		...
		k2= kF.createKarta("Tximinoa", "Gorria");
		k3= kF.createKarta("Tximinoa", "Urdina");
		k4= kF.createKarta("Lehoia", "Gorria");
		k5= kF.createKarta("Lehoia", "Urdina");
		kZ=t.getKola();
	}
	...
	public void testGaitasunaBurutu() {
		...
		assertNull(kZ.getKarta(1).equals(k5));
		kZ.kartaEzabatu(k4);
		...
		k5.gaitasunaBurutu(0);
		assertTrue(kZ.getKarta(0).equals(k5));
		assertNull(kZ.getKarta(1).equals(k2));
		...
		assertNull(kZ.getKarta(3).equals(k5));
		kZ.kartaEzabatu(k1);
		kZ.kartaEzabatu(k2);
		kZ.kartaEzabatu(k4);
		...
		assertNull(kZ.getKarta(4).equals(k5));
		
		k4.gaitasunaBurutu(0);
		assertTrue(kZ.getKarta(0).equals(k4));
		assertTrue(kZ.getKarta(1).equals(k1));
		assertNull(kZ.getKarta(2).equals(k2));
		assertNull(kZ.getKarta(3).equals(k3));
